...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_NODECPP_RAWPOINTERDEREFERENCECHECK_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_NODECPP_RAWPOINTERDEREFERENCECHECK_H
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_NODECPP_RAWPOINTERDEREFERENCECHECK_H
