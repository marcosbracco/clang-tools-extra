...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_NODECPP_NOCASTCHECK_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_NODECPP_NOCASTCHECK_H
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_NODECPP_NOCASTCHECK_H
